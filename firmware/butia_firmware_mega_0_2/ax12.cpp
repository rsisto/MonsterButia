...
void AX12::autoDetect (int* list_motors, byte num_motors) {                // escanea todos los ID hasta el 254 mandando PINGs
...
void AX12::setEndlessTurnMode (boolean onoff) {           // prende o apaga el modo "endless turn"
...
int makeInt (byte l, byte h) {          // transforma 2 bytes en un int
    return (h << 8) | l;
}
