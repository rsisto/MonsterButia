...
# Además hace un threshold para mostrar lo que se selecciona con el rango
...
#           
# Se puede usar con la cámara o una imagen.
...
#Cuando se están calibrando colores con Hue cercano a 0, por ejemplo rojo. Por defecto, dejar en False
#Si está en true, la discontinuidad del hue se mueve a los 90 grados.
hueNearZero = False
